...
const ekUrunler: UrunKaydi[] = [
  {
    sku: 'BAR-001',
    ad: 'Barista Espresso Makinesi Pro',
    birim: 'ADET',
    fiyat: 12499,
    envanter: 36,
    kdv: 20,
    barkodlar: ['8690001000001'],
    barkodDetay: { '8690001000001': { birim: 'ADET', fiyat: 12499, kdv: 20 } },
  },
  {
    sku: 'BAR-002',
    ad: 'Barkod Okuyucu El Tipi',
    birim: 'ADET',
    fiyat: 1890,
    envanter: 112,
    kdv: 20,
    barkodlar: ['8690002000002'],
    barkodDetay: { '8690002000002': { birim: 'ADET', fiyat: 1890, kdv: 20 } },
  },
  {
    sku: '30.0003',
    ad: 'HP LaserJet Toner 85A',
    birim: 'ADET',
    fiyat: 690,
    envanter: 48,
    kdv: 20,
    barkodlar: ['8690003000003'],
    barkodDetay: { '8690003000003': { birim: 'ADET', fiyat: 690, kdv: 20 } },
  },
  ...
  { sku: '10.0001', ad: 'Fiyat Farkı Kalemi', birim: 'ADET', fiyat: 0, envanter: 9999, kdv: 0, barkodlar: ['8690001000001'] },
