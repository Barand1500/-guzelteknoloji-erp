...
export const ADMIN_MODUL_REHBERLERI: Record<string, ModulRehber> = {
  ...
  'belgeler-alan-yonet': {
    ...
    kartlar: [
      ...
      {
        baslik: '2) Alta satır açmak (+1 … +4)',
        aciklama:
          'Önce boş satır aç. +1 = tek yuvalı satır (ör. Adres tek başına). +2 = yan yana 2 yuva (ör. Telefon | GSM). +3 … +4 aynı mantık. Bu butonlar alan eklemez; sadece kaç sütunluk satır istediğini söyler.',
        renk: 'yesil',
      },
      {
