...
export const PANEL_SOZLUK_TR: Record<string, string> = {
  ...
  'aksiyon.guncelle': 'Düzenle',
  'aksiyon.guncelle.arctos-db-ayarlari': 'Sına',
  'aksiyon.guncelle.stoklar': 'Düzenle',
  'aksiyon.onizle': 'Önizle',
  'aksiyon.onizle.stoklar': 'İncele',
  'aksiyon.ekle.stoklar': 'Yeni',
...
export const PANEL_SOZLUK_EN: Record<string, string> = {
  ...
  'aksiyon.guncelle.stoklar': 'Edit',
  'aksiyon.onizle': 'Preview',
  'aksiyon.onizle.stoklar': 'Inspect',
  'aksiyon.ekle.stoklar': 'New',
